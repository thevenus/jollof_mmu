...
#  Created by Genus(TM) Synthesis Solution 16.12-s027_1 on Thu Feb 15 16:41:24 +0100 2024
...
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports read_ram]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports valid_input]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[4]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[5]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[6]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_data[7]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports finish]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {read_data_out[8]}]
